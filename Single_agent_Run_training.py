from Single_agent_Perudo_environment import Perudo_environment
from Single_agent_Perudo_training import train_perudo_agents
...
if __name__ == '__main__':
    ...
    agent_number = 1
    file_location = 'baby_mono_Q_net'
    script_location = 'Logs/baby_mono_log'
